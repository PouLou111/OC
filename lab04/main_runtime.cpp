...
bool init_lib() {
  void* hdl_gcf_lib = dlopen("home/poulou/OC/lab04/build/libgcf.so", RTLD_LAZY);
  void* hdl_prime_lib = dlopen("home/poulou/OC/lab04/build/libprime_numbers.so", RTLD_LAZY);
